...
def refold(X, n, shape):
    """
    Обратная операция разворачивания. Восстанавливает тензор по развернутой матрице и указанному режиму.
...
def mode(X, Y, n):
    """
    Многодиновое произведение матрицы X и матрицы Y по указанной моде n.
